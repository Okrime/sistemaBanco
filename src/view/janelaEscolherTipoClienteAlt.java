...
public class janelaEscolherTipoClienteAlt extends Shell {
	...
	public static void main(String args[]) {
		try {
			...
			janelaEscolherTipoClienteAlt shell = new janelaEscolherTipoClienteAlt(display);
			shell.open();
			shell.layout();
	 ...
	 * @param display
	 */
	public janelaEscolherTipoClienteAlt(Display display) {
		...
		btnPrximo.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (btnPessoaFisica.getSelection()){
					setVisible(false);
					janelaFuncionarioAltClienteFis facf = new janelaFuncionarioAltClienteFis(display);
					facf.setVisible(true);
					
				} else if(btnPessoaJuridica.getSelection()){
					setVisible(false);
					janelaFuncionarioAltClienteJur facj = new janelaFuncionarioAltClienteJur(display);
					facj.setVisible(true);
				}
			}
		});
